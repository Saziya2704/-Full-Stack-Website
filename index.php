...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/carousel1.jpg" alt="food flavours" height="470" class="d-block w-100">
      <div class="carousel-caption">
        <h1>Delicious</h1>
        <p>Your Taste, Our Way!</p>
      </div>   
    </div>
    <div class="carousel-item">
      <img src="img/carousel2.jpg" alt="Chicago" height="470" class="d-block w-100">
      <div class="carousel-caption">
        <h1>TastyBites</h1>
    ...
    <div class="carousel-item">
      <img src="img/carousel3.jpeg" alt="New York" height="470" class="d-block w-100">
      <div class="carousel-caption">
        <h1>FlavorFusion</h1>
...
<div class="container-fluid">	
    <div class="col-sm-6 col-lg-10" style="margin-left:100px;">
	...
	<?php
	  ...
	  <div class="container-fluid col-4">
	     <div class="row" style="padding:10px; ">
		      <div class="col-sm-2"><img src="<?php echo $hotel_logo; ?>" class="rounded-circle" height="10px" width="10px" alt="Cinque Terre"></div>
		      <div class="col-sm-5">
...
<div class="container-fluid">
     <div class="row"><!--main row-->
	                        ...
	                        tbfood on tblvendor.fldvendor_id=tbfood.fldvendor_id");
		                         ...
		                         <!--add to cart-->    <div class="col-sm-2" style="text-align:left;padding:10px; font-size:25px;"><button type="submit"  name="addtocart" value="<?php echo $res['food_id'];?>"><span style="color:green;"><i class="fa fa-shopping-cart" aria-hidden="true"></i></span></button></div>
	                                           ...
	                                           <div class="container-fluid"><!--product row container 2-->
	                                                <div class="row" style="padding:10px;padding-top:0px;padding-right:0px; padding-left:0px;">
		                           <!--food Image-->     <div class="col-sm-12"><img src="<?php echo $food_pic; ?>" class="rounded" height="240px" width="60%" alt="Cinque Terre"></div>
		 		                                    </div>
	                                            </div>
	                                            <div class="container-fluid"><!--product row container 3-->
	                                                 <div class="row" style="padding:10px; ">
		                                                 <div class="col-sm-12">
														 <span><?php echo "Rs".$res['cost']; ?>&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		                               <!--cuisine-->          <span><?php echo $res['cuisines']; ?></span>
									   <br>
		                                <!--cost-->           
		                                <!--deliverytime-->    
		                                                 </div>
	   ...
	   <a href="index.html">
        <button class= btn btn-success><a href="nutrition calculator\index.html">Nutrition Calculator</a></button>
    </a>
	<!--footer-->
	<?php
			include("footer.php");
